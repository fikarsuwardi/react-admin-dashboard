...
const overviewData = [
  { name: "Revenue", value: "IDR 1,234,567", change: 12.5, icon: DollarSign },
  { name: "Users", value: "IDR 45,678", change: 8.3, icon: Users },
  { name: "Orders", value: "IDR 9,876", change: -3.2, icon: ShoppingBag },
  { name: "Page Views", value: "IDR 1,234,567", change: 15.7, icon: Eye },
];
